    ...
    execute: function () {
      ...
      _export("GameController", GameController = (_dec = ccclass('GameController'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Prefab), _dec10 = property(Sprite), _dec(_class = (_class2 = class GameController extends Component {
        ...
        _buildGrid() {
          ...
          const TILE_SIZE = 120;
          const GAP = 8;
          const totalW = (_crd && GRID_COLS === void 0 ? (_reportPossibleCrUseOfGRID_COLS({
            error: Error()
          }), GRID_COLS) : GRID_COLS) * (TILE_SIZE + GAP) - GAP;
          const totalH = (_crd && GRID_ROWS === void 0 ? (_reportPossibleCrUseOfGRID_ROWS({
            error: Error()
          }), GRID_ROWS) : GRID_ROWS) * (TILE_SIZE + GAP) - GAP;

          for (let r = 0; r < (_crd && GRID_ROWS === void 0 ? (_reportPossibleCrUseOfGRID_ROWS({
            error: Error()
          }), GRID_ROWS) : GRID_ROWS); r++) {
            this._tileNodes[r] = [];

            for (let c = 0; c < (_crd && GRID_COLS === void 0 ? (_reportPossibleCrUseOfGRID_COLS({
              error: Error()
              ...
              const tc = node.getComponent(_crd && TileNode === void 0 ? (_reportPossibleCrUseOfTileNode({
                error: Error()
              }), TileNode) : TileNode);
        ...
        _checkPath() {
          const result = (_crd && solve === void 0 ? (_reportPossibleCrUseOfsolve({
            error: Error()
